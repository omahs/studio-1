...
const BrandPage = () => {
	...
	const [buttonRadius, setButtonRadius] = useState(
		appState.theme.components.MuiButton.styleOverrides.root.borderRadius
	);
	const [shapeRadius, setShapeRadius] = useState(
		appState.theme.shape.borderRadius
	);
			...
			<Grid container spacing={gridSpacing} sx={{ p: 3 }}>
				<Grid item xs={12} justifyContent="center">
					...
					<Typography variant="body">
						Colors displayed as part of the theme
					</Typography>
					<Paper
						variant="outlined"
						sx={{ p: 3, mt: 2 }}
					...
					>
						...
						>
							...
							<Grid item xs={4} xl={4} justifyContent="center">
								...
								<BlockPicker
									color={
										appState.theme.palette.secondary.main
									}
									onChangeComplete={(color) =>
					...
					>
						...
						>
							...
							<Slider
								...
								aria-label="Volume"
								value={buttonRadius}
								onChange={configureButtonRadius}
							/>
							<CircleOutlinedIcon />
						</Stack>
						<Stack
				...
				<Grid item xs={12}>
					...
					<Typography variant="body">
						Displayed on the top left corner and the footer
					</Typography>
					<Paper
						variant="outlined"
						sx={{ p: 3, mt: 2 }}
