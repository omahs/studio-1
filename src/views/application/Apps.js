...
export default function Examples() {
	...
	const bootstrapApp = (config) => {
		...
		controller.save().then(
			(updatedController) => {
				...
				setSelectedEVM(
					updatedController.attributes.configuration.network
				);
				setAbiDefinition(
					updatedController.attributes.configuration.abi
				);
				dispatch({
					type: SNACKBAR_OPEN,
					open: true,
			...
			<FormControl variant="standard" fullWidth>
				...
				<Input
					...
					onChange={(e) => {
						...
						selectedApp.attributes.configuration.about.appName =
							e.target.value;
					}}
					aria-describedby="appName-text"
					defaultValue={selectedApp?.attributes.name}
				/>
				<FormHelperText id="appName-text">
					Text that will displayed as the application controller title
				</FormHelperText>
			</FormControl>
			<FormControl variant="standard" fullWidth>
				...
				<Input
					id="imageUrl"
					onChange={(e) => {
						selectedApp.attributes.configuration.about.imageUrl =
							e.target.value;
					}}
				...
				/>
				<FormHelperText id="imageUrl-text">
					Image banner url that will be displayed in the about page
				</FormHelperText>
			</FormControl>
			<FormControl variant="standard" fullWidth>
				...
				<Input
					id="title"
					onChange={(e) => {
						selectedApp.attributes.configuration.about.title =
							e.target.value;
					}}
				...
				<FormHelperText id="title-text">
					Text header that will be displayed as title for the
					description
				</FormHelperText>
			</FormControl>
			<FormControl variant="standard" fullWidth>
				...
				<Input
					...
					multiline
					onChange={(e) => {
						selectedApp.attributes.configuration.about.description =
							e.target.value;
					}}
				...
				<FormHelperText id="description-text">
					Descriptive text about your App. What is it about? how do
					you use it?
				</FormHelperText>
			</FormControl>
	...
	const customNetwork = (
		<Grid item>
			<FormControl variant="standard" fullWidth>
				...
				/>
				<FormHelperText id="networkImage-text">
					Text that will displayed as the application controller title
				</FormHelperText>
			</FormControl>
			<FormControl variant="standard" fullWidth>
				...
				/>
				<FormHelperText id="networkName-text">
					Text that will displayed as the application controller title
				</FormHelperText>
			</FormControl>
			<FormControl variant="standard" fullWidth>
				...
				/>
				<FormHelperText id="networkId-text">
					Text that will displayed as the application controller title
				</FormHelperText>
			</FormControl>
			<FormControl variant="standard" fullWidth>
				...
				/>
				<FormHelperText id="networkRpc-text">
					Text that will displayed as the application controller title
				</FormHelperText>
			</FormControl>
			<FormControl variant="standard" fullWidth>
				<InputLabel htmlFor="networkRpc">
				...
				/>
				<FormHelperText id="networkSymbol-text">
					Text that will displayed as the application controller title
				</FormHelperText>
			</FormControl>
			<FormControl variant="standard" fullWidth>
				...
				/>
				<FormHelperText id="networkCurrencyName-text">
					Text that will displayed as the application controller title
				</FormHelperText>
			</FormControl>
			<FormControl variant="standard" fullWidth>
				...
				/>
				<FormHelperText id="networkExplorerUrl-text">
					Text that will displayed as the application controller title
				</FormHelperText>
			</FormControl>
		</Grid>
	...
	const abiForm = selectedApp.id && (
		<Grid item xs={12} sx={{ my: 2 }}>
			<Grid item sx={{ mb: 2 }}>
				...
				<Typography variant="body">
					Please paste your contract ABI below
				</Typography>
			</Grid>
			<AceEditor
				width="100%"
	...
	const formEditor = selectedApp.id && (
		<Grid item>
			<Accordion
				...
				onChange={handleChangeAcc("appPanel")}
				sx={{ width: "100%" }}
			>
				<AccordionSummary
					aria-controls="appPanel-content"
					id="appPanel-header"
				>
					<Typography
						sx={{
			...
			<Accordion
				expanded={expanded === "networkPanel"}
				onChange={handleChangeAcc("networkPanel")}
				sx={{ width: "100%" }}
			>
				<AccordionSummary
					aria-controls="networkPanel-content"
					id="networkPanel-header"
				>
					<Typography
						sx={{
							fontSize: "1.5em",
			...
			<Accordion
				expanded={expanded === "abiPanel"}
				onChange={handleChangeAcc("abiPanel")}
				sx={{ width: "100%" }}
			>
				<AccordionSummary
					aria-controls="abiPanel-content"
					id="abiPanel-header"
				>
					<Typography
						sx={{
				...
				<AccordionDetails>
					<FormControl variant="standard" fullWidth>
						...
						/>
						<FormHelperText id="contract-text">
							The smart contract address deployed
						</FormHelperText>
					</FormControl>
					{abiForm}
				</AccordionDetails>
	...
	const openInMetamaskMobile = isMobile && !window.web3 && (
		<Paper
			elevation={1}
			sx={{ borderRadius: 0, p: 2, backgroundColor: "ivory" }}
			xs={12}
		>
			<span style={{ marginRight: "10px" }}>
				Your browser does not support Web3, please open with
			</span>
			<a
				href="https://metamask.app.link/dapp/physicalweb3.com/dashboard"
				target="_blank"
				rel="noreferrer"
			>
				Metamask App
	...
	const openInMetamaskDesk = !isMobile && !window.web3 && (
		...
		>
			<span style={{ marginRight: "10px" }}>
				Your browser does not support Web3, please install
			</span>
			<a
	...
	const authenticatePanel = window.web3 && user === null && (
		<Paper
			elevation={1}
			sx={{ borderRadius: 0, p: 2, cursor: "pointer" }}
			xs={12}
				...
				<MenuItem key={applicationItem.id} value={applicationItem.id}>
					<Grid item xs={12}>
						<Typography variant="h5">
							{applicationItem.attributes.name}
						</Typography>
	...
	const templatePicker = isTemplatePicker && (
		<Picker onSelect={onTemplateSelect} />
	);
	...
	return (
		...
		>
			...
			<Grid item md={6} id="mobile-frame">
				{selectedApp.id && (
					<MobileDevicePreview controllerUrl={getPreviewUrl()} />
				)}
			</Grid>
