...
const Picker = ({ onSelect }) => {
    ...
    const compileContract = async () => {
        ...
        // const dependencyUrl =
        //     'https://raw.githubusercontent.com/OpenZeppelin/openzeppelin-contracts/v3.4.0/contracts/presets/ERC721PresetMinterPauserAutoId.sol';
        // const dependencyFile = await fetch(dependencyUrl);
        // const dependencyBlob = await dependencyFile.text();
        // const depFile = {
        //     fileName: {
        //         content: dependencyBlob
        //     }
        // };
        // compiler.gatherImports(depFile, null, (res, e) => {
        //     console.log(e);
        //     console.log(res);
